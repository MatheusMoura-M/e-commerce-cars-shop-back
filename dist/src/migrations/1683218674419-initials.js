...
exports.initials1683218674419 = void 0;
class initials1683218674419 {
    constructor() {
        this.name = 'initials1683218674419';
    }
    up(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield queryRunner.query(`ALTER TABLE "images" ADD CONSTRAINT "FK_c966d343d95687961368797192e" FOREIGN KEY ("carId") REFERENCES "cars"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
...
exports.initials1683218674419 = initials1683218674419;
//# sourceMappingURL=1683218674419-initials.js.map