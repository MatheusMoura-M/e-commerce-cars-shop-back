...
__decorate([
    (0, typeorm_1.ManyToOne)(() => index_1.User, (user) => user.id, {
        onDelete: "CASCADE",
    }),
    __metadata("design:type", index_1.User)
], Comments.prototype, "users", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => index_1.Car, (car) => car.id, {
        onDelete: "CASCADE",
    }),
    __metadata("design:type", index_1.Car)
], Comments.prototype, "cars", void 0);
__decorate([
    (0, typeorm_1.Column)(),
    __metadata("design:type", String)
