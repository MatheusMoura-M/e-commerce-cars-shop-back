...
export class initials1682518783237 implements MigrationInterface {
  name = "initials1682518783237";
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(200) NOT NULL, "email" character varying(127) NOT NULL, "cpf" character varying(11) NOT NULL, "password" character varying(120) NOT NULL, "telephone" character varying(12) NOT NULL, "isActive" boolean NOT NULL DEFAULT true, "description" character varying(300) NOT NULL, "image_url" character varying(300) NOT NULL, "isSeller" boolean NOT NULL DEFAULT false, "birthdate" TIMESTAMP NOT NULL, "addressId" uuid, CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "UQ_230b925048540454c8b4c481e1c" UNIQUE ("cpf"), CONSTRAINT "REL_bafb08f60d7857f4670c172a6e" UNIQUE ("addressId"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
